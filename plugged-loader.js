 ...
 *     	in, https://github.com/Eddyjim/Plugedd, that is well-visible
...
/*
 * @author  Edward Jimenez (Eddyjim)  <edward.jimenez.m@gmail.com>
 */

/**
 * Repository path of the Javascript files
 */
var path = 'https://raw.github.com/Eddyjim/Plugbot/master/';

/**
 * Shows a message out to the chatbox on plug.dj, displayed locally.
 *
 * @param msg  The message to print.
 */
function showMesage(msg)
{
  $('#chat-messages').append('<div class="update">'+
		  						'<span class="text" style="color:#ffd900;font-weight:bold">' 
		  								+ msg + 
		  						'</span>'+
		  					'</div>');
}
...
$.getScript(path + '/plugedd.js', function() {
  print('Plugedd welcomes you.');
